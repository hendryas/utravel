<div class="boxed_wrapper">
  ...
  <div class="tour-package">
    <div class="container">
      <div class="row">
        <?php foreach ($data_pencarian as $pencarian) : ?>
          <div class="col-lg-4 col-md-6">
            <div class="tour-package-container">
              <div class="activities-image">
                <a href="#"><img src="<?= base_url('assets/images/img_wisata/') . $pencarian['gambar_wisata']; ?>" alt="photo"></a>
              </div>
              <div class="activities-content">
                <div class="tour-package-info">
                  ...
                  <div class="doller">
                    Dari <span>Rp <?= number_format($pencarian['harga_tiket']); ?></span>
                  </div>
                </div>
                <a href="<?= base_url('utravel/detailwisata/') . $pencarian['id_wisata']; ?>/<?= $post; ?> "><?php echo $pencarian['nama_wisata'] ?></a>
                <ul>
                  <li><i class="flaticon-placeholder"></i> <?php echo $pencarian['lokasi_wisata'] ?></li>
                </ul>
              </div>
            </div>
          </div>
